...
这里，我们可以找到项目地址：[https://github.com/WuBMHDTV/gitHelp](https://github.com/WuBMHDTV/gitHelp)，然后点击页面右上角的 **“fork”** 按钮，这样就把你关注的项目fork到你自己的账号下了。  
...
提交完成以后，我们需要把我们的修改合并到[gitHelp](https://github.com/WuBMHDTV/gitHelp)中，打开你自己的gitHelp项目克隆，地址是 [https://github.com/XXXXXX/gitHelp](https://github.com/XXXXXX/gitHelp)，点击上的 **Pull Request** 按钮，然后填写一些提交的信息，完成
